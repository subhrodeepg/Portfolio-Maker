...
public class PortfolioTest {
    ...
    void addStockTest() {
        ...
        assertFalse(portfolio.isContainsStockTicker("MSFT"));
        ...
        assertTrue(portfolio.isContainsStockTicker("MSFT"));
    }

    @Test
    void deleteStockSuccessAtFirstPositionTest() {
        assertEquals(1, portfolio.getStockListLength());
        assertTrue(portfolio.isContainsStockTicker("AAPL"));
        assertTrue(portfolio.deleteStock(stock));
        assertEquals(0, portfolio.getStockListLength());
        assertFalse(portfolio.isContainsStockTicker("AAPL"));
    }
